...
/// * a `TruncatedReader`, implementing only the `Read` trait. It is responsible for reading bytes when recovering an archive
///
...
// Size of the recovered file blocks
...
pub(crate) mod tests {
    ...
    fn check_archive_format_v2_content() {
        ...
        // Get a reader on the recovered archive
