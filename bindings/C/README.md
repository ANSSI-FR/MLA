...
[tests/linux-gcc-g++/create.c](tests/linux-gcc-g++/create.c)

### Reading an MLA

[tests/linux-gcc-g++/open.c](tests/linux-gcc-g++/open.c)

**Notes:**
- For reading, you need the recipient's private key (for decryption) and the signer's public key (for signature verification).
- The API supports notably listing entries, opening by name, and reading file contents.
